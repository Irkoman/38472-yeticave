...
INSERT INTO user (date_add, email, password, name, avatar, contact) VALUES
  (NOW(), 'ignat.v@gmail.com', '$2y$10$OqvsKHQwr0Wk6FMZDoHo1uHoXd4UdxJG/5UDtUiie00XaxMHrW8ka', 'Игнат', '/img/avatar.jpg', 'ignat.v@gmail.com'),
  (NOW(), 'kitty_93@li.ru', '$2y$10$bWtSjUhwgggtxrnJ7rxmIe63ABubHQs0AS0hgnOo41IEdMHkYoSVa', 'Леночка', '/img/lenok.jpg', '+7(900)000-21-34'),
  (NOW(), 'warrior07@mail.ru', '$2y$10$2OxpEH7narYpkOT1H5cApezuzh10tZEEQ2axgFOaKW.55LxIJBgWW', 'Руслан', '/img/user.jpg', 'Зеленоград, Старое Крюково');
