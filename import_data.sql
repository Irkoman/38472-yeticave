...
INSERT INTO user (date_add, email, password, name, avatar, contact) VALUES
  ...
  (NOW(), 'kitty_93@li.ru', '$2y$10$bWtSjUhwgggtxrnJ7rxmIe63ABubHQs0AS0hgnOo41IEdMHkYoSVa', 'Леночка', '/img/upload/avatar.jpg', '+7(900)000-21-34'),
...
INSERT INTO lot (category_id, user_id, winner_id, date_add, date_close, title, description, image, initial_rate, rate_step, fav_count) VALUES
  ...
  (4, 3, NULL, NOW(), '2017-07-20 00:00:00', 'THE NORTH FACE KEIRYO DIAD HIGH RISK', 'Ткань обработана специальной пропиткой DWR для усиления водоотталкивающих свойств. Мембрана с полиуретановым покрытием великолепно защищает от дождя, ветра и обладает высокой паропроницаемостью.', 'img/upload/shop_items_catalog_image10160.jpg', 5500, 50, 5);
