...
<main>
  ...
  <form class="form container <?= !empty($errors) ? 'form--invalid' : '' ?>" action="signup.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form__item <?= !empty($errors['message']) ? 'form__item--invalid' : '' ?>">
      ...
      <textarea id="message" name="message" value="<?= isset($_POST['message']) ? $_POST['message'] : '' ?>" placeholder="Напишите, как с вами связаться"></textarea>
    ...
    <div class="form__item form__item--file form__item--last">
      ...
      <div class="preview">
        ...
        <div class="preview__img">
          <img src="<?= empty($errors['avatar']) && !empty($file['tmp_name']) ? '../img/' . $file['name'] : '' ?>" width="113" height="113" alt="Аватар">
        </div>
      </div>
